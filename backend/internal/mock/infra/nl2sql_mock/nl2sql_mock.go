...
import (
	...
	document "github.com/superagent-ai/superagent-base/backend/infra/document"
	nl2sql "github.com/superagent-ai/superagent-base/backend/infra/document/nl2sql"
...
func (m *MockNL2SQL) NL2SQL(ctx context.Context, messages []*einobridge.Message, tables []*document.TableSchema, opts ...nl2sql.Option) (string, error) {
	m.ctrl.T.Helper()
