...
func startHttpServer(agentRT *agentdef.AgentRuntime, skillMgr *skill.Manager, toolMgr *tool.Manager, mcpRegistry *mcp.Registry, userStore *rbac.UserStore, evoEngine *evolution.Engine, sharedMem memory.Backend, agentDefStore *agentdef.AgentDefinitionStore) {
