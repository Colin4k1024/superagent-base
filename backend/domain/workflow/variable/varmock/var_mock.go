...
import (
	...
	variable "github.com/superagent-ai/superagent-base/backend/domain/workflow/variable"
...
func (m *MockStore) Get(ctx context.Context, path einobridge.FieldPath, opts ...variable.OptionFn) (any, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Set(ctx context.Context, path einobridge.FieldPath, value any, opts ...variable.OptionFn) error {
	m.ctrl.T.Helper()
