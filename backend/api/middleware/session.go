...
import (
	...
	"github.com/superagent-ai/superagent-base/backend/api/internal/httputil"
	...
	"github.com/superagent-ai/superagent-base/backend/domain/user/entity"
...
func SessionAuthMW() app.HandlerFunc {
	return func(c context.Context, ctx *app.RequestContext) {
		...
		if strings.HasPrefix(path, "/api/v1/skills/") || strings.HasPrefix(path, "/api/v1/admin/") || strings.HasPrefix(path, "/api/admin/") || strings.HasPrefix(path, "/api/v1/xiaohai/") || strings.HasPrefix(path, "/api/v1/chat/") || strings.HasPrefix(path, "/api/v1/agents") || strings.HasPrefix(path, "/api/v2/") {
			ctx.Next(c)
			return
		}
