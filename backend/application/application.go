...
import (
	...
	"github.com/superagent-ai/superagent-base/backend/application/permission"

	"github.com/superagent-ai/superagent-base/backend/application/app"
	"github.com/superagent-ai/superagent-base/backend/application/base/appinfra"
	"github.com/superagent-ai/superagent-base/backend/application/connector"
	"github.com/superagent-ai/superagent-base/backend/application/conversation"
	"github.com/superagent-ai/superagent-base/backend/application/knowledge"
	"github.com/superagent-ai/superagent-base/backend/application/memory"
	"github.com/superagent-ai/superagent-base/backend/application/modelmgr"
	"github.com/superagent-ai/superagent-base/backend/application/openauth"
	"github.com/superagent-ai/superagent-base/backend/application/plugin"
	"github.com/superagent-ai/superagent-base/backend/application/prompt"
	"github.com/superagent-ai/superagent-base/backend/application/shortcutcmd"
	"github.com/superagent-ai/superagent-base/backend/application/singleagent"
	"github.com/superagent-ai/superagent-base/backend/application/template"
	"github.com/superagent-ai/superagent-base/backend/application/upload"
	"github.com/superagent-ai/superagent-base/backend/application/user"
	"github.com/superagent-ai/superagent-base/backend/application/workflow"
	crossagent "github.com/superagent-ai/superagent-base/backend/crossdomain/agent"
	singleagentImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/agent/impl"
	crossagentrun "github.com/superagent-ai/superagent-base/backend/crossdomain/agentrun"
	agentrunImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/agentrun/impl"
	crossapp "github.com/superagent-ai/superagent-base/backend/crossdomain/app"
	appImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/app/impl"
	crossconnector "github.com/superagent-ai/superagent-base/backend/crossdomain/connector"
	connectorImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/connector/impl"
	crossconversation "github.com/superagent-ai/superagent-base/backend/crossdomain/conversation"
	conversationImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/conversation/impl"
	crossdatabase "github.com/superagent-ai/superagent-base/backend/crossdomain/database"
	databaseImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/database/impl"
	crossdatacopy "github.com/superagent-ai/superagent-base/backend/crossdomain/datacopy"
	dataCopyImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/datacopy/impl"
	crossknowledge "github.com/superagent-ai/superagent-base/backend/crossdomain/knowledge"
	knowledgeImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/knowledge/impl"
	crossmessage "github.com/superagent-ai/superagent-base/backend/crossdomain/message"
	messageImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/message/impl"
	crosspermission "github.com/superagent-ai/superagent-base/backend/crossdomain/permission"
	permissionImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/permission/impl"
	crossplugin "github.com/superagent-ai/superagent-base/backend/crossdomain/plugin"
	pluginImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/plugin/impl"
	crossupload "github.com/superagent-ai/superagent-base/backend/crossdomain/upload"
	uploadImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/upload/impl"
	crossuser "github.com/superagent-ai/superagent-base/backend/crossdomain/user"
	crossuserImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/user/impl"
	crossvariables "github.com/superagent-ai/superagent-base/backend/crossdomain/variables"
	variablesImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/variables/impl"
	crossworkflow "github.com/superagent-ai/superagent-base/backend/crossdomain/workflow"
	workflowImpl "github.com/superagent-ai/superagent-base/backend/crossdomain/workflow/impl"
	"github.com/superagent-ai/superagent-base/backend/application/search"
	...
	progressBarImpl "github.com/superagent-ai/superagent-base/backend/infra/document/progressbar/impl/progressbar"
	"github.com/superagent-ai/superagent-base/backend/infra/eventbus"
	implEventbus "github.com/superagent-ai/superagent-base/backend/infra/eventbus/impl"
	"github.com/superagent-ai/superagent-base/backend/infra/sqlparser"
	sqlparserImpl "github.com/superagent-ai/superagent-base/backend/infra/sqlparser/impl/sqlparser"
...
func Init(ctx context.Context) (err error) {
	...
	eb := initEventBus(infra)

	basicServices, err := initBasicServices(ctx, infra, eb)
	if err != nil {
...
func initPrimaryServices(ctx context.Context, basicServices *basicServices) (*primaryServices, error) {
	...
	appSVC, err := app.InitService(basicServices.toAPPServiceComponents(memorySVC))
	if err != nil {
		return nil, err
	}
...
func (b *basicServices) toAPPServiceComponents(memorySVC *memory.MemoryApplicationServices) *app.ServiceComponents {
	infra := b.infra
	return &app.ServiceComponents{
		...
		ProjectEventBus: b.eventbus.projectEventBus,
		UserSVC:         b.userSVC.DomainSVC,
		ConnectorSVC:    b.connectorSVC.DomainSVC,
		VariablesSVC:    memorySVC.VariablesDomainSVC,
	}
}
